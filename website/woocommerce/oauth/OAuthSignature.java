package website.woocommerce.oauth;

import website.woocommerce.HttpMethod;
...
/**
 * icoderman.WooCommerce specific OAuth signature generator
 */
public class OAuthSignature {
    ...
    public static Map<String, String> getAsMap(OAuthConfig config, String endpoint, HttpMethod httpMethod, Map<String, String> params) {
        ...
        // icoderman.WooCommerce specified param
